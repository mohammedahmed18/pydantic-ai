...
def _tool_config(function_names: list[str]) -> ToolConfigDict:
    # Use cached mode and class constructors
    function_calling_config = _FCCD(mode=_ANY_MODE, allowed_function_names=function_names)
    return _TCD(function_calling_config=function_calling_config)
...
_FCCD = FunctionCallingConfigDict
